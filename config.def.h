...
static const int horizpadbar = 15; // horizontal padding for status bar
static const int vertpadbar = 15; // vertical padding for status bar
...
static const char col_br_magenta[]  = "#685589";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_gray3, col_gray1, col_gray2 },
	[SchemeSel]  = { col_gray4, col_br_magenta,  col_br_magenta	},
};
...
static Key keys[] = {
	...
	{ControlMask, XK_Print, spawn, SHCMD("sleep 5s;scrot --select")},
